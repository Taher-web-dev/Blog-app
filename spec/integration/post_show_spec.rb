...
RSpec.describe 'Login', type: :system do
  ...
  it 'can test post show features' do
    ...
    unless Post.find_by(title:'time').comments_counter == 3
        ...
        comment_1 = Comment.create(user:user_1,post:current_post,text:'I like it')
        comment_2 = Comment.create(user:user_2,post:current_post,text:'Agree with u!')
        comment_3 = Comment.create(user:user_3,post:current_post,text:'Bravo!')
