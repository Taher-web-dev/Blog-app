...
RSpec.describe 'Login', type: :system do
  ...
  it 'can test post index features' do
    ...
    unless Post.find_by(title: 'management').comments_counter == 3
      ...
      Comment.create(user: current_user, post: current_post, text: 'I like it')
      Comment.create(user: current_user, post: current_post, text: 'Agree with u!')
      Comment.create(user: current_user, post: current_post, text: 'Bravo!')
